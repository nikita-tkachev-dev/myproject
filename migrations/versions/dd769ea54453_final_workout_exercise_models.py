...
def upgrade():
    ...
    sa.Column('day_of_week', sa.Enum('mon', 'tue', 'wed', 'thu', 'fri', 'sat', 'sun', name='week_days'), nullable=False),
    ...
    op.create_table('workout_plan_sessions',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('exercise_sets', schema=None) as batch_op:
        batch_op.add_column(sa.Column('is_warmup', sa.Boolean(), nullable=False))
